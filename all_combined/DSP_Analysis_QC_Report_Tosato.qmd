...
params:
  ...
  results.folder: "/Users/cauleyes/CPTR/CPTR-8_2_Tosato/QC/"
  run.folder: "8_16_24/"
---
...
annotation.file.name <- "annotation_tosato_CPTR8_2.xlsx"
...
signal.to.noise.boxplot <- function(signal.to.noise.df, 
  ...
  median.select.columns <- c("Treatment group", "region", "s2n_median")
