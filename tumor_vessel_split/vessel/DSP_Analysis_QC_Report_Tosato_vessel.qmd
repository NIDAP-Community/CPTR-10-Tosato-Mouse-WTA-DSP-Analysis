---
title: "DSP Analysis QC Report: CPTR-10 Tosato Vessel Only"
format:
  html:
    code-fold: true
editor: visual
...
annotation.file.name <- "annotation_tosato_CPTR8_vessel.xlsx"
...
if(write.qc.file == TRUE){
  ...
  saveWorkbook(qc.info.output, paste0(params$results.folder, 
                                      params$run.folder, 
                                      "QC_info.xlsx"), overwrite = TRUE)
...
# Add new column names for the exported counts file
...
if(export.counts == TRUE){
  ...
  if(norm.type == "quantile"){
    ...
    # Write the counts with custom column name
    write.csv(q3.counts.custom, 
              file = paste0(params$results.folder,
                            "Tosato_q3_counts_vessel_renamed.csv"))
 
    # Write the counts with original dcc column name
    write.csv(q3.normalization.output$object@assayData$q_norm, 
              file = paste0(params$results.folder,
                            "Tosato_q3_counts_vessel.csv"))
    
    # Save RDS of counts and annotation for Shiny
    counts.df <- as.data.frame(q3.normalization.output$object@assayData$q_norm)
    annotation.df <- as.data.frame(pData(q3.normalization.output$object))
    
    saveRDS(counts.df, 
            file = paste0(params$results.folder,
                            "Tosato_q3_counts_vessel.RDS"))
    saveRDS(annotation.df, 
            file = paste0(params$results.folder,
                            "Tosato_filtered_annotation_vessel.RDS"))
...
```{r PCA for Q3 Animal ID, fig.width=12, fig.height=8}
#| label: fig-PCAanimalIDQ3
#| fig-cap: "PCA colored by Animal_ID for Q3 Normalization"
#| warning: false

q3.pca.plot.animalID <- biplot(q3.pca.table, 
                         colby = "Animal_ID", 
...
ggplotly(q3.pca.plot.animalID)

print(q3.pca.plot.animalID)

if(export.PCA == TRUE){
  
  ggsave(paste0(params$results.folder, 
                params$run.folder, 
                "PCA/Vessel_PCA_Q3_animalID.png"), 
         q3.pca.plot.animalID, 
         height = 8, 
         width = 12)
...
#                         subtitle = "NTCs removed")
#
#ggplotly(q3.pca.plot.segment)

```

```{r PCA for Negative Animal ID, fig.width=12, fig.height=8}
#| label: fig-PCAanimalIDNeg
#| fig-cap: "PCA colored by Animal_ID for Negative Normalization"
#| warning: false

neg.pca.plot.animalID <- biplot(neg.pca.table, 
                         colby = "Animal_ID", 
                         legendPosition = "right", 
                         legendLabSize = 6, 
                         legendIconSize = 3, 
...
print(neg.pca.plot.animalID)

if(export.PCA == TRUE){
  
  ggsave(paste0(params$results.folder, 
                params$run.folder, 
                "PCA/Vessel_PCA_Neg_animalID.png"), 
         neg.pca.plot.animalID, 
         height = 8, 
         width = 12)
...
```{r PCA for Quant animal ID, fig.width=12, fig.height=8}
#| label: fig-PCAanimalIDQuant
#| fig-cap: "PCA colored by animal ID for Quantile Normalization"
#| warning: false

quant.pca.plot.animalID <- biplot(quant.pca.table, 
                         colby = "Animal_ID", 
                         legendPosition = "right", 
                         legendLabSize = 6, 
                         legendIconSize = 3, 
...
print(quant.pca.plot.animalID)

if(export.PCA == TRUE){
  
  ggsave(paste0(params$results.folder, 
                params$run.folder, 
                "PCA/Vessel_PCA_Quant_animalID.png"), 
         quant.pca.plot.animalID, 
         height = 8, 
         width = 12)
...
if(export.PCA == TRUE){
  ...
  ggsave(paste0(params$results.folder, 
                params$run.folder, 
                "PCA/Vessel_PCA_quant_region.png"), 
         quant.pca.plot.region, 
         height = 8, 
         width = 12)
...
if(export.PCA == TRUE){
  ...
  ggsave(paste0(params$results.folder, 
                params$run.folder, 
                "PCA/Vessel_PCA_Quant_class.png"), 
         quant.pca.plot.class, 
         height = 8, 
         width = 12)
...
if(export.PCA == TRUE){
  ...
  ggsave(paste0(params$results.folder, 
                params$run.folder, 
                "PCA/Vessel_PCA_Quant_slide.png"), 
         quant.pca.plot.slide, 
         height = 8, 
         width = 12)
...
if(export.PCA == TRUE){
  ...
  ggsave(paste0(params$results.folder, 
                params$run.folder, 
                "PCA/Vessel_PCA_Quant_nuclei.png"), 
         quant.pca.plot.nuclei, 
         height = 8, 
         width = 12)
